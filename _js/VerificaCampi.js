...
function txtNumberLostfocus(objCtrl,blnSepMigliaia)
{
	...
	//se in questo evento c'Ë un punto lo considera come separatore dei decimali 
...
{
	//vengono intercettati gli errori in modo che se il controllo non Ë visibile
...
//controlla se il campo di testo Ë vuoto
...
function IsValidChar(sText)
{
	...
	var ValidChars = "0123456789QWERTYUIOPASDFGHJKLZXCVBNMqwertyuioplkjhgfdsazxcvbnm¿»…Ã“Ÿ‡ËÈÏÚ˘«Á'&$@[\/]^_∞{}~+-.:,;() |";
	var IsNumber=true;
	var Char;
