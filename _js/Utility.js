...
function SplitValue(vrnInputParam, strSeparator) 
{
  ...
  do 
  {
    ...
    //Verifica che il carattere successivo non sia lo stesso carattere del separatore, in questo caso non sarebbe un separatore valido ma un carattere raddoppiato (vedi byte stuffing)
