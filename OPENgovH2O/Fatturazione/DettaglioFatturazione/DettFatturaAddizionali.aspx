<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DettFatturaAddizionali.aspx.vb" Inherits="OpenUtenze.DettFatturaAddizionali"%>
<%@ Register Assembly="Ribes.OPENgov.WebControls" Namespace="Ribes.OPENgov.WebControls" TagPrefix="Grd" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>DettFatturaAddizionali</title>
					...
					<td>
						...
						<Grd:RibesGridView ID="GrdAddizionali" runat="server" BorderStyle="None" 
							...
							<Columns>
								...
								<asp:BoundField DataField="impAddizionale" HeaderText="Importo " DataFormatString="{0:N}">
									<ItemStyle HorizontalAlign="Right"></ItemStyle>
								</asp:BoundField>
