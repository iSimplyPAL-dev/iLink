<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PosizioneContatore.aspx.vb" Inherits="OpenUtenze.PosizioneContatore" %>
...
<HTML>
	...
	<body class="Sfondo" onload="document.getElementById('txtPosizione').focus();" bottomMargin="0" leftMargin="0" topMargin="0" marginwidth="0" marginheight="0">
		<form id="Form1" runat="server" method="post">
			...
			<table cellSpacing="1" cellPadding="1" width="98%" align="center" border="0">
				...
				<tr>
				<tr>
					<td class="Input_Label" noWrap width="25%">Posizione</td>
				</tr>
				<tr>
					<td><asp:textbox id="txtPosizione" tabIndex="1" runat="server" CssClass="Input_Text_Right" onblur="if (!isNumber(this.value)){GestAlert('a', 'warning', '', '', 'Inserire solo NUMERI!')}" Width="150" MaxLength="10"></asp:textbox></td>
				</tr>
				<tr>
					<td class="Input_Label" noWrap width="25%">Descrizione&nbsp;<FONT class="NormalRed">*</FONT></td>
				</tr>
				<tr>
					<td><asp:textbox id="txtDescrizione" tabIndex="2" runat="server" cssclass="Input_Text" Width="476px" MaxLength="200"></asp:textbox></td>
				</tr>
				<tr>
					<td class="Input_Label" noWrap width="25%">Note</td>
				</tr>
				<tr>
					<td><asp:textbox id="txtNote" tabIndex="3" runat="server" Cssclass="Input_Text" Width="650px" Height="80" TextMode="MultiLine" onKeyDown="controlla(this,frmTabelle,300);" onKeyUp="controlla(this,frmTabelle,300);"></asp:textbox></td>
				</tr>
				<tr>
				</tr>
			</table>
