<%@ Page Language="vb" CodeBehind="SearchDiametroPresa.aspx.vb" AutoEventWireup="false" Inherits="OpenUtenze.SearchDiametroPresa" EnableEventValidation="false" %>
...
<body class="Sfondo" bottommargin="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    <form id="Form1" runat="server" method="post">
        <table cellspacing="1" cellpadding="1" width="98%" align="center" border="0">
            ...
            <tr>
                <td>
                    <Grd:RibesGridView ID="GrdDiametroPresa" runat="server" BorderStyle="None"
                        ...
                        <Columns>
                            <asp:BoundField DataField="DIAMETROPRESA" HeaderText="Diametro Presa"></asp:BoundField>
                            ...
                            <asp:TemplateField HeaderText="">
                                ...
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" Cssclass="BottoneGrd BottoneApriGrd" CommandName="RowOpen" CommandArgument='<%# Eval("CODDIAMETROPRESA") %>' alt=""></asp:ImageButton>
                                    <asp:HiddenField runat="server" ID="hfCODDIAMETROPRESA" Value='<%# Eval("CODDIAMETROPRESA") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </Grd:RibesGridView>
