<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ComandiOperazioniSuTabelleSistema.aspx.vb" Inherits="OpenUtenze.ComandiOperazioniSuTabelleSistema"%>
...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			function Salva()
			{
			    parent.Visualizza.iframetabella.getElementById('btnSalva').click();
			}
			function Cancella()
			{
				if (confirm('Si desidera eseguire la cancellazione dell\'elemento selezionato?'))
				{	
				    parent.Visualizza.iframetabella.getElementById('btnCancella').click();
				}		
				else
				{
					return false;
			...
			function Annulla()
			{
			    parent.Visualizza.iframetabella.getElementById('btnAnnulla').click();
	
			}
	</script>
	</HEAD>
	<BODY class="SfondoGenerale" bottomMargin="0" rightmargin="2" leftMargin="2" topMargin="10"
