<%@ Page Language="vb" CodeBehind="SearchTipiContatore.aspx.vb" AutoEventWireup="false" Inherits="OpenUtenze.SearchTipoContatore" EnableEventValidation="false" %>
...
<body class="Sfondo" bottommargin="0" leftmargin="0" topmargin="0" marginwidth="0"
    ...
    <form id="Form1" runat="server" method="post">
        <table cellspacing="1" cellpadding="1" width="98%" align="center" border="0">
            ...
            <tr>
                <td>
                    <Grd:RibesGridView ID="GrdTipiContatore" runat="server" BorderStyle="None"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="VALOREFONDOSCALA" HeaderText="Valore Fondo Scala">
                            ...
                            <asp:TemplateField HeaderText="">
                                ...
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" Cssclass="BottoneGrd BottoneApriGrd" CommandName="RowOpen" CommandArgument='<%# Eval("IDTIPOCONTATORE") %>' alt=""></asp:ImageButton>
            ...
            <tr>
                <td>
                    <iframe id="iframetabella" name="iframetabella" width="95%" src="../../aspVuota.aspx" frameborder="0" height="310"></iframe>
                </td>
            </tr>
        </table>
