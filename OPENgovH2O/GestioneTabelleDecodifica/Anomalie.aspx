<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Anomalie.aspx.vb" Inherits="OpenUtenze.Anomalie" %>
...
<HTML>
	...
	<body class="Sfondo" onload="document.getElementById('txtCodiceAnomalia').focus();" bottomMargin="0" leftMargin="0" topMargin="0" marginwidth="0" marginheight="0">
		<form id="Form1" runat="server" method="post">
			...
			<table cellSpacing="1" cellPadding="1" width="98%" align="center" border="0">
				...
				<tr>
					<td class="Input_Label" noWrap width="25%">Codice Anomalia</td>
				</tr>
				<tr>
					<td><asp:textbox id="txtCodiceAnomalia" tabIndex="1" runat="server" cssclass="Input_Text" Width="150" MaxLength="10"></asp:textbox></td>
				</tr>
				<tr>
				...
				<tr>
					<td><asp:textbox id="txtNote" tabIndex="3" runat="server" Cssclass="Input_Text" Width="650px" Height="80" TextMode="MultiLine" onKeyDown="controlla(this,frmTabelle,200);" onKeyUp="controlla(this,frmTabelle,200);"></asp:textbox></td>
				</tr>
				<tr>
				</tr>
			</table>
