<%@ Page Language="vb" CodeBehind="SearchFognatura.aspx.vb" AutoEventWireup="false" Inherits="OpenUtenze.SearchFognatura" %>
...
<body class="Sfondo" bottommargin="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    <form id="Form1" runat="server" method="post">
        <table cellspacing="1" cellpadding="1" width="98%" align="center" border="0">
            ...
            <tr>
                <td>
                    <Grd:RibesGridView ID="GrdFognatura" runat="server" BorderStyle="None"
                        ...
                        <Columns>
                            <asp:BoundField DataField="CODICEFOGNATURA" HeaderText="Codice Fognatura"></asp:BoundField>
                            ...
                            <asp:TemplateField HeaderText="">
                                ...
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" Cssclass="BottoneGrd BottoneApriGrd" CommandName="RowOpen" CommandArgument='<%# Eval("CODFOGNATURA") %>' alt=""></asp:ImageButton>
                                    <asp:HiddenField runat="server" ID="hfCODFOGNATURA" Value='<%# Eval("CODFOGNATURA") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </Grd:RibesGridView>
