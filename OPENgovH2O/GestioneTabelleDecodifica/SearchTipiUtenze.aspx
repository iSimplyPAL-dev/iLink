<%@ Page Language="vb" CodeBehind="SearchTipiUtenze.aspx.vb" AutoEventWireup="false" Inherits="OpenUtenze.SearchTipiUtenze" EnableEventValidation="false" %>
...
<body class="Sfondo" bottommargin="0" leftmargin="0" topmargin="0" marginwidth="0"
    ...
    <form id="Form1" runat="server" method="post">
        <table cellspacing="1" cellpadding="1" width="98%" align="center" border="0">
            ...
            <tr>
                <td>
                    <Grd:RibesGridView ID="GrdTipiUtenze" runat="server" BorderStyle="None"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="">
                                ...
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" Cssclass="BottoneGrd BottoneApriGrd" CommandName="RowOpen" CommandArgument='<%# Eval("IDTIPOUTENZA") %>' alt=""></asp:ImageButton>
