<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DiametroPresa.aspx.vb" Inherits="OpenUtenze.DiametroPresa" %>
...
<HTML>
	<HEAD>
		...
		function VerificaCampi()
				...
				////'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''/
					...
					if(!IsBlank(document.getElementById('txtDiametroPresa').value ))
					{			
							if(document.getElementById('txtDiametroPresa').value < 0)
							{
								alert("Diametro Presa non valido inserire un valore maggiore di zero!");
								Setfocus(document.getElementById('txtDiametroPresa'));
								return false;
							} 
							if(!isNumber(document.getElementById('txtDiametroPresa').value,5,1))
							{
								alert("Diametro Presa non valido inserire una sola cifra decimale!");
								Setfocus(document.getElementById('txtDiametroPresa'));
								return false;
							}
						}			
						...
						{
							alert("Diametro Presa obbligatorio!");
							Setfocus(document.getElementById('txtDiametroPresa'));
							return false;
						}	
					return true; 
	...
	<body class="Sfondo" onload="document.getElementById('txtDiametroPresa').focus();" bottomMargin="0" leftMargin="0" topMargin="0" marginwidth="0" marginheight="0">
		<form id="Form1" runat="server" method="post">
			...
			<table cellSpacing="1" cellPadding="1" width="98%" align="center" border="0">
				...
				<tr>
					<td class="Input_Label" noWrap width="25%">Diametro Presa&nbsp;<FONT class="NormalRed">*</FONT></td>
					<td class="Input_Label" noWrap width="25%">&nbsp;<!--Tariffa Contatore--></td>
				</tr>
				<tr>
					<td><asp:textbox id="txtDiametroPresa" tabIndex="1" runat="server" cssclass="Input_Number_Generali" MaxLength="5" onfocus="txtNumberGotfocus(this);" onblur="txtNumberLostfocus(this);"></asp:textbox></td>
					<td>&nbsp;<!--<asp:dropdownlist id="cboTariffeContatori" tabIndex="2" runat="server" Width="150" Cssclass="Input_Text"></asp:dropdownlist>--></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2"><asp:textbox id="txtNote" tabIndex="4" runat="server" Cssclass="Input_Text" Width="650px" Height="80" TextMode="MultiLine" onKeyDown="controlla(this,frmTabelle,300);" onKeyUp="controlla(this,frmTabelle,300);"></asp:textbox></td>
				</tr>
				<tr>
				</tr>
			</table>
