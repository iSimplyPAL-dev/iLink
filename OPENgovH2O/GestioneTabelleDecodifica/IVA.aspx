<%@ Page Language="vb" AutoEventWireup="false" Codebehind="IVA.aspx.vb" Inherits="OpenUtenze.IVA" %>
...
<HTML>
	...
	<body class="Sfondo" onload="document.getElementById('txtCodiceIVA').focus();" bottomMargin="0" leftMargin="0" topMargin="0" marginwidth="0" marginheight="0">
		<form id="Form1" runat="server" method="post">
			...
			<table cellSpacing="1" cellPadding="1" width="98%" align="center" border="0">
				...
				<tr>
					<td class="Input_Label_Bold" noWrap width="25%">Codice IVA</td>
				</tr>
				<tr>
					<td><asp:textbox id="txtCodiceIVA" tabIndex="1" runat="server" cssclass="Input_Text" Width="150" MaxLength="10"></asp:textbox></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="Input_Label_Bold" noWrap width="25%">Note</td>
				</tr>
				<tr>
