...
Partial Class ComandiOperazioniSuTabelleSistema
    Inherits BasePage
    ...
    Private Shared Log As ILog = LogManager.GetLogger(GetType(ComandiOperazioniSuTabelleSistema))
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            End If
            info.Text = "Acquedotto - Configurazioni - " & CType(ConstSession.DescrTipoProcServ, String).Replace("Tabella", "")
        ...
        Catch ex As Exception
            ...
            Log.Debug(ConstSession.IdEnte +"."+ ConstSession.UserName + " - OPENgovH2O.ComandiOperazioniSuTabelleSistema.Page_Load.errore: ", ex)
