<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Giri.aspx.vb" Inherits="OpenUtenze.Giri" %>
...
<HTML>
	...
	<body class="Sfondo" onload="document.getElementById('txtCodiceGiro').focus();" bottomMargin="0" leftMargin="0" topMargin="0" marginwidth="0" marginheight="0">
		<form id="Form1" runat="server" method="post">
			...
			<table cellSpacing="1" cellPadding="1" width="98%" align="center" border="0">
				...
				<tr>
					<td class="Input_Label" noWrap width="25%">Codice Giro</td>
				</tr>
				<tr>
					<td><asp:textbox id="txtCodiceGiro" tabIndex="1" runat="server" cssclass="Input_Text" Width="150" MaxLength="10"></asp:textbox></td>
				</tr>
				<tr>
