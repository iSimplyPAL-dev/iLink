<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Attivita.aspx.vb" Inherits="OpenUtenze.ATTIVITA" %>
...
<html>
	...
	<body class="Sfondo" onload="document.getElementById('txtDescrizione').focus();" bottomMargin="0"
			...
			<table cellSpacing="1" cellPadding="1" width="98%" align="center" border="0">
				...
				<tr>
					<td><asp:textbox id="txtNote" tabIndex="3" runat="server" Cssclass="Input_Text" Width="650px"
							Height="80" TextMode="MultiLine" onKeyDown="controlla(this,frmTabelle,200);" onKeyUp="controlla(this,frmTabelle,200);"></asp:textbox></td>
				</tr>
				<tr>
				</tr>
			</table>
