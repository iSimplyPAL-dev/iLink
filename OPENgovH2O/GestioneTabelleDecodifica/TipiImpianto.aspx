<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TipiImpianto.aspx.vb" Inherits="OpenUtenze.TipiImpianto" %>
...
<HTML>
	...
	<body class="Sfondo" onload="document.getElementById('txtCodiceImpianto').focus();" bottomMargin="0"
		...
		<form id="Form1" runat="server" method="post">
			...
			<table cellSpacing="1" cellPadding="1" width="98%" align="center" border="0">
				...
				<tr>
					<td class="Input_Label" noWrap width="25%">Codice Impianto</td>
				</tr>
				<tr>
					<td><asp:textbox id="txtCodiceImpianto" tabIndex="1" runat="server" cssclass="Input_Text"
				...
				<tr>
					<td><asp:textbox id="txtNote" tabIndex="3" runat="server" Cssclass="Input_Text" Width="764px"
