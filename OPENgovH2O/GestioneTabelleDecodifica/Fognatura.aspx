<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Fognatura.aspx.vb" Inherits="OpenUtenze.Fognatura" %>
...
<HTML>
	...
	<body class="Sfondo" onload="document.getElementById('txtCodiceFognatura').focus();" bottomMargin="0"
		...
		<form id="Form1" runat="server" method="post">
			...
			<table cellSpacing="1" cellPadding="1" width="98%" align="center" border="0">
				...
				<tr>
					<td class="Input_Label" noWrap width="25%">Codice Fognatura</td>
				</tr>
				<tr>
					<td><asp:textbox id="txtCodiceFognatura" tabIndex="1" runat="server" cssclass="Input_Text"
