...
#End Region
    Private Shared Log As ILog = LogManager.GetLogger(GetType(CRicercaNoloC))
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Catch ex As Exception
            ...
            Log.Debug(ConstSession.IdEnte +"."+ ConstSession.UserName + " - OPENgovH2O.CRicercaNoloC.Page_Load.errore: ", ex)
