<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CConfiguraNoloC.aspx.vb" Inherits="OpenUtenze.CConfiguraNoloC"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>CConfiguraNoloC</title>
		...
		<script type="text/javascript">
			function Conferma()
			{
				if (confirm('Si vogliono salvare i dati del Nolo Contatore?'))
				{
		...
		<form id="Form1" runat="server" method="post">
			<table cellSpacing="0" cellPadding="0" width="100%" align="right" border="0" id="Table1">
				<tr>
					...
					<input class="Bottone Bottonecancella" id="Delete" title="Elimina Nolo" onclick="ConfermaCancellazione()" type="button" name="Erase"> 
                    <input class="Bottone BottoneSalva" id="Insert" title="Salva Nolo" onclick="ControllaDati()" type="button" name="Insert"> 
