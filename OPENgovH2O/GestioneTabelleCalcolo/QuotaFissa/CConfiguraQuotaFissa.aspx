<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CConfiguraQuotaFissa.aspx.vb" Inherits="OpenUtenze.CConfiguraQuotaFissa"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
  <head>
    <title>CConfiguraQuotaFissa</title>
    ...
    <meta name=vs_targetSchema content="http://schemas.microsoft.com/intellisense/ie5">
		...
		<script type="text/javascript">			
			function Conferma()
			{
				if (confirm('Si vogliono salvare i dati della Quota Fissa?'))
				{
		...
		<form id="Form1" runat="server" method="post">
			<table cellSpacing="0" cellPadding="0" width="100%" align="right" border="0" id="Table1">
				<tr>
					...
					<input class="Bottone Bottonecancella" id="Delete" title="Elimina Quota Fissa" onclick="ConfermaCancellazione()"
						type="button" name="Erase"> 
                    <input class="Bottone BottoneSalva" id="Insert" title="Salva Quota Fissa" onclick="ControllaDati()"
						type="button" name="Insert"> 
                    <input class="Bottone BottoneAnnulla" id="Cancel" title="Torna alla Gestione" onclick="ConfermaUscita()"
