...
Partial Class CRicercaQuotaFissa
    Inherits BasePage
...
#End Region
    Private Shared Log As ILog = LogManager.GetLogger(GetType(CRicercaQuotaFissa))
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Catch ex As Exception
            ...
            Log.Debug(ConstSession.IdEnte +"."+ ConstSession.UserName + " - OPENgovH2O.CRicercaQuotaFissa.Page_Load.errore: ", ex)
