...
Partial Class ComandiConfiguraDescrizioni
    Inherits BasePage
    Private Shared Log As ILog = LogManager.GetLogger(GetType(ComandiConfiguraDescrizioni))
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Catch ex As Exception
            ...
            Log.Debug(ConstSession.IdEnte +"."+ ConstSession.UserName + " - OPENgovH2O.ComandiConfiguraDescrizioni.Page_Load.errore: ", ex)
