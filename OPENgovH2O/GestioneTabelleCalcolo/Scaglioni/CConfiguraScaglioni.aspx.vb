...
Partial Class CConfiguraQuotaFissa1
    Inherits BasePage
...
#End Region
    Private Shared Log As ILog = LogManager.GetLogger(GetType(CConfiguraQuotaFissa1))
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Catch ex As Exception
            Log.Debug(ConstSession.IdEnte +"."+ ConstSession.UserName + " - OPENgovH2O.CConfiguraQuotaFissa1.Page_Load.errore: ", ex)
