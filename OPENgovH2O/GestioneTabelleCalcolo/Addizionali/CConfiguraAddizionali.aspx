<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CConfiguraAddizionali.aspx.vb" Inherits="OpenUtenze.CConfiguraAddizionali"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>CConfiguraAddizionali</title>
		...
		<script type="text/javascript">
			//function Disabilita(){
			//	if("<%=session("dirittioperatore")%>"=="LETTURA")
			//{
			...
			function Conferma()
			{
				if (confirm('Si vogliono salvare i dati dell\' Addizionale?'))
				{
			...
			<table cellSpacing="0" cellPadding="0" width="100%" align="right" border="0" id="Table1">
				<tr>
					...
					<td align="right" width="800" colSpan="2" rowSpan="2">
						<input class="Bottone Bottonecancella" id="Delete" title="Elimina Addizionale" onclick="ConfermaCancellazione()"
							type="button" name="Erase"> <input class="Bottone BottoneSalva" id="Insert" title="Salva Addizionale" onclick="ControllaDati()"
