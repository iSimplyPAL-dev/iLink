<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CInserimentoPagamenti.aspx.vb" Inherits="OpenUtenze.CInserimentoPagamenti"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>CInserimentoPagamenti</title>
			...
			<table cellSpacing="0" cellPadding="0" width="100%" align="right" border="0" id="Table1">
				<tr>
					...
					<td align="right" width="800" colSpan="2" rowSpan="2">
						<input class="Bottone Bottonecancella" id="Delete" title="Elimina Pagamento" onclick="ConfermaCancellazione()"
							type="button" name="Erase"><input class="Bottone BottoneSalva" id="Insert" title="Salva Pagamento" onclick="SalvaPagamento()"
							type="button" name="Insert"><input class="Bottone BottoneRicerca" id="Search" title="Ricerca" onclick="parent.Visualizza.Search()"
							type="button" name="Search"><input class="Bottone BottoneAnnulla" id="Cancel" title="Torna alla Gestione" onclick="parent.Visualizza.ConfermaUscita()"
