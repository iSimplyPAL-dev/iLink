...
Partial Class CRicercaPagamenti
    Inherits BasePage
...
#End Region
    Private Shared Log As ILog = LogManager.GetLogger(GetType(CRicercaPagamenti))
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            End If
            info.Text = "Acquedotto - Pagamenti - Ricerca"
            Comune.Text = ConstSession.DescrizioneEnte & "   -   Periodo: " & ConstSession.DescrPeriodo
        Catch ex As Exception

            Log.Debug(ConstSession.IdEnte +"."+ ConstSession.UserName + " - OPENgovH2O.CRicercaPagamenti.Page_Load.errore: ", ex)
