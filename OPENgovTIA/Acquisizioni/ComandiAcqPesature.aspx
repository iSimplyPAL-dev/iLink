<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ComandiAcqPesature.aspx.vb" Inherits="OPENgovTIA.ComandiAcqPesature"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<head>
		<title>ComandiAcqPesature</title>
			...
			<table cellSpacing="0" cellPadding="0" width="100%" align="right" border="0" id="Table1">
				<TR>
					...
					<TD align="right" width="800" colSpan="2" rowSpan="2">
						<INPUT class="Bottone BottoneImport" id="Import" title="Acquisizione Pesature" onclick="parent.Visualizza.document.getElementById('CmdImporta').click()" type="button" name="Import">
					</TD>
				</TR>
				<TR>
					<TD style="WIDTH: 463px" align="left">
						<SPAN class="NormalBold_title" id="info" runat="server" style="WIDTH: 400px; HEIGHT: 20px">
							TARSU Variabile - Acquisizione Conferimenti</SPAN>
					</TD>
				</TR>
			</table>
			&nbsp;
