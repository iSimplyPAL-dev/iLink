<%@ Control Language="vb" AutoEventWireup="false" Codebehind="WucDatiContribuente.ascx.vb" Inherits="Provvedimenti.WucDatiContribuente" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
