<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ComandiConfigMotivazioni.aspx.vb" Inherits="Provvedimenti.ComandiConfigMotivazioni"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
  <HEAD>
    <title>ComandiConfigMotivazioni</title>
	...
	<script type ="text/javascript">
		function PopolaLabel(){
			...
			document.getElementById("info").innerText="Configurazione - Tabelle - Motivazioni"
        }
	</script>
</HEAD>
	<body class="SfondoGenerale" onload="PopolaLabel()" bottomMargin="leftMargin="topMargin="6" rightMargin="2" marginheight="0" marginwidth="0" 0? 2?>
				...
				<table cellSpacing="0" cellPadding="0" width="100%" align="right" border="0">
					<tr>
						...
						<div id="divsalva" style="DISPLAY: none">
							...
							<INPUT class="Bottone Bottoneannulla" id="indietro" title="Torna alla videata precedente" onclick="parent.Visualizza.indietro()" type="button" name="Search">
						</div>
						</td>
					</tr>
					<tr>
