<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SearchDatiDichiarato.aspx.vb" Inherits="Provvedimenti.SearchDatiDichiaratoTASI" %>
	...
	<body class="Sfondo" bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" marginheight="0" marginwidth="0">
		<form id="Form1" runat="server" method="post">
			<table cellPadding="0" width="100%" border="0">
				...
				<tr>
					<td>
                        <asp:label id="lblTesto" runat="server" CssClass="Input_Label" Visible="False">Per Ribaltare in automatico tutti gli immobili selezionare l'opzione "Seleziona 
							...
							corrispondente.</asp:label>
					</td>
				</tr>
				<tr>
					<td align="right">
						<asp:checkbox id="chkSelTutti" runat="server" CssClass="Input_Label" Text="Seleziona tutti" Visible="False" AutoPostBack="True"></asp:checkbox>
					</td>
				</tr>
			</table>
