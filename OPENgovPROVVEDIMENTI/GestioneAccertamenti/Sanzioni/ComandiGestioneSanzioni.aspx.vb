''' <summary>
''' Pagina dei comandi per la gestione delle sanzioni in generazione provvedimento.
''' Le possibili opzioni sono:
''' - Associa
''' - Torna alla videata precedente
''' </summary>
''' <remarks>In ottemperanza alle linee guida di sviluppo 1.0</remarks>
Partial Class ComandiGestioneSanzioni
    Inherits BasePage
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Select Case ConstSession.CodTributo
            ...
            Case Utility.Costanti.TRIBUTO_OSAP
                info.InnerText = "OSAP "
        End Select
        info.InnerText += " - Accertamenti - Sanzioni"
    End Sub
