<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrameRicercaAnater.aspx.vb" Inherits="Provvedimenti.FrameRicercaAnater" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<TITLE>Ricerca Immobili Anater</TITLE>
		<%
	dim Source
	dim codContribuente
	dim anno
	...
	Source="SearchAnater.aspx?codContribuente=" & codContribuente & "&anno=" & anno & "&nominativo=" & nominativo
%>
