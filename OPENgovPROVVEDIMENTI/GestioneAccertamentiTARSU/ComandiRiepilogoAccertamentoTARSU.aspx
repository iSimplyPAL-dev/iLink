<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ComandiRiepilogoAccertamentoTARSU.aspx.vb" Inherits="Provvedimenti.ComandiRiepilogoAccertamentoTARSU"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
  <head>
		<title>ComandiRiepilogoAccertamentoTARSU</title>
		...
		<form id="Form1" runat="server" method="post">
			<table cellSpacing="0" cellPadding="0" width="100%" align="right" border="0">
				<tr>
					...
					<td align="right" >
						<input class="Bottone BottoneAnnulla" id="btnSearch" runat="server" title="Accerta una nuova posizione" onclick="parent.Visualizza.location.href='GestioneAccertamentiTARSU.aspx';return false;" type="button" name="btnSearch">
