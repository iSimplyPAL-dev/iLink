<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CGestioneAccertamentiTARSU.aspx.vb" Inherits="Provvedimenti.CGestioneAccertamentiTARSU"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>CGestioneAccertamentiTARSU</title>
		...
		<script>
			function VisualizzaLabel(){
			    ...
			    parent.Comandi.info.innerText = 'Accertamenti TARES/TARI - Gestione';//"<%=Session("DESC_TIPO_PROC_SERV") %>" + '  -  Ricerca'			
			}
		...
		<table cellSpacing="0" cellPadding="0" width="100%" align="right" border="0">
			<tr>
				...
				<td align="right" width="800" colSpan="2" rowSpan="2">
					<INPUT class="Bottone BottoneJudgeHammer" id="CmdAnnulloNoAcc" title="Crea Autotutela di annullamento senza accertato" onclick="parent.Visualizza.document.getElementById('BtnAnnulloNoAcc').click()" type="button" name="CmdAnnullo">
					...
					<INPUT class="Bottone BottoneUserHome hidden" id="VersContribuente" title="Visualizza Versamenti del Contribuente" onclick="parent.Visualizza.gotoVersContribuente();" type="button" name="VersContribuente"> 
