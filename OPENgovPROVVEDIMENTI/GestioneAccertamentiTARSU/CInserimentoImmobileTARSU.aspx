<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CInserimentoImmobileTARSU.aspx.vb" Inherits="Provvedimenti.CInserimentoImmobileTARSU"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>CInserimentoImmobileTARSU</title>
		...
		function VisualizzaLabel(){
			...
			parent.Comandi.info.innerText= "<%=Session("DESC_TIPO_PROC_SERV") %>" + '  - Inserimento Manuale Immobile'
		...
		<table cellSpacing="0" cellPadding="0" width="100%" align="right" border="0">
			<tr>
				...
				<td align="right" width="800" colSpan="2" rowSpan="2">
					<INPUT class="Bottone BottoneAssocia" id="btnAssocia" title="Associa gli immobili al soggetto" onclick="parent.Visualizza.getElementById('btnRibalta').click()" type="button" name="btnAssocia"> 
                    <INPUT class="Bottone BottonePulisci hidden hidden" id="Clear" title="Pulisci videata per nuova Associazione" onclick="parent.Visualizza.PulisciCampi()" type="button" name="Clear">
