	...
	if (questa.value!=""){
		if (riferimento.value != ""){
			...
			if (NewDateRif > NewDateQues) {
				if (msg!=""){
					alert("La data immessa e' antecedente a quella " + msg + " (" + riferimento.value + ")")
					questa.value=""
					questa.focus()
					return false
				}else{
					alert("La data immessa e' antecedente al " + riferimento.value)
					questa.value=""
					questa.focus()
					return false
				}	
			...
			if (questa.value == riferimento) {
				if (msg!=""){
					alert("La data immessa non puo' essere uguale a quella " + msg + " (" + riferimento.value + ")")
					questa.value=""
					questa.focus()
					return false
				}else{
					alert("La data immessa non puo' essere uguale al " + riferimento.value )
					questa.value=""
					questa.focus()
					return false
				}
...
function verificaPercentuale(oggetto){
	var valore=new String(oggetto.value)
	valore=valore.replace (/\,/,".")
	if (valore!=""){
		if (valore>100){
			alert ("La percentuale non puo' superare il 100%.")
			oggetto.value=""
			oggetto.focus()
			return false
		}
...
//*** 20120629 - IMU ***
function VerificaPercentCarico(PercCarico)
{
	if (PercCarico.value!=50)
	{		
		if (PercCarico.value!=100)
		{		
		    alert("La percentuale deve essere 50 o 100!");
		    PercCarico.value='100';
			Setfocus(PercCarico);
			return false;
		}
	}
