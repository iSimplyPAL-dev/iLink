...
// strDivNameClose nome della seconda div che fa le funzioni di "promemoria chiuso"
{
	...
	strOut += "						<img src=\"" + strPathImg + "_img/lstOrderByDESC.gif\" border=0 name=\"imgfilter\"></a></td>";
...
function CambiaStato(strDivName,strDivNameAttiva,strPathImg)
{
	if (!isUndefined(LeggiLayer('divFiltroDRAG')))
	{
		...
		if (document.images['imgfilter'].src.indexOf("lstOrderByDESC.gif")!=-1)
			document.images['imgfilter'].src= strPathImg + "_img/lstOrderByASC.gif";
		else
			document.images['imgfilter'].src= strPathImg + "_img/lstOrderByDESC.gif"
