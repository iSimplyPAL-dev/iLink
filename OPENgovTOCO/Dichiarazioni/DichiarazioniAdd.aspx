...
<%@ Page Language="C#" AutoEventWireup="True" Codebehind="DichiarazioniAdd.aspx.cs" Inherits="OPENgovTOCO.Dichiarazioni.DichiarazioniAdd"%>
					...
					<tr>
						<td colspan="2">
							<span class="NormalBold_title" id="info" style="WIDTH: 400px; HEIGHT: 20px">
								TOSAP/COSAP - Dichiarazioni - Gestione</span>
						</td>
					</tr>
				</table>
			</div>
				<asp:button id="btnRibalta" Text="btnRibalta" style="display:none" Runat="server" onclick="btnRibalta_Click"></asp:button>
