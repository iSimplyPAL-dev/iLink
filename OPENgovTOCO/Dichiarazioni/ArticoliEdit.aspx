...
<%@ Page Language="C#" AutoEventWireup="True" Codebehind="ArticoliEdit.aspx.cs" Inherits="OPENgovTOCO.Dichiarazioni.ArticoliEdit"%>
					...
					<tr>
						<td colspan="2">
							<span class="NormalBold_title" id="info" style="WIDTH: 400px; HEIGHT: 20px">
								TOSAP/COSAP - Dichiarazioni - Gestione - Modifica Articolo</span>
						</td>
					</tr>
				</table>
			</div>
