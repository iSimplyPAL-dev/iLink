<%@ Page language="c#" Codebehind="ArticoliView.aspx.cs" AutoEventWireup="True" Inherits="OPENgovTOCO.Dichiarazioni.ArticoliView" %>
					...
					<tr>
						<td colspan="2">
							<span class="NormalBold_title" id="info" style="WIDTH: 400px; HEIGHT: 20px">
								TOSAP/COSAP - Dichiarazioni - Gestione - Visualizza Articolo</span>
						</td>
					</tr>
				</table>
			</div>
